...
def attack(char_name: str, char_class: str) -> str:
    """Return a message indicating the amount of damage."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return a message indicating the amount of blocked damage."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Return a message.
    The message indicates which special skill was used and its size.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Print a message about training start.
    Print description of choosen commands.
    Return a message, that says, that training was ended.
    """
    if char_class == 'warrior':
